...
import { commonFormItemListMap, defaultConnectFFTModel, defaultConnectTcpModel, Endian32BitList, propNameEnum } from "../enum";
import { useDevCfgInnerData } from "../innerData";

export default defineComponent({
  name: 'ConnectFFTModelForm',
  setup(props, ctx) {
    const innerData = useDevCfgInnerData()
    const formCfg = reactive({
      form: innerData.isEdit ? innerData.connectCfgForm : { ...defaultConnectFFTModel },
      optionMap: {
