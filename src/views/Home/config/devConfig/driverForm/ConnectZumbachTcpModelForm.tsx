...
import { commonFormItemListMap, defaultConnectZumbachComModel, defaultConnectZumbachTcpModel, Endian32BitList, propNameEnum } from "../enum";
import { useDevCfgInnerData } from "../innerData";

export default defineComponent({
  name: 'ConnectZumbachTcpModel',
  setup(props, ctx) {
    const innerData = useDevCfgInnerData()
    const formCfg = reactive({
      form: innerData.isEdit ? innerData.connectCfgForm : { ...defaultConnectZumbachTcpModel },
      optionMap: {
      ...
      itemList: [
        ...
        commonFormItemListMap[propNameEnum.ReadBuffSize],
        commonFormItemListMap[propNameEnum.Split],
      ] as formListItem[],
      hideBtn: false,
      noLargeBtn: true,
