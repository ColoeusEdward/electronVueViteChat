...
import { commonFormItemListMap,  defaultConnectSikoraComModel,  defaultConnectSikoraTcpModel, Endian32BitList, propNameEnum } from "../enum";
import { useDevCfgInnerData } from "../innerData";

export default defineComponent({
  name: 'ConnectSikoraComModel',
  setup(props, ctx) {
    const innerData = useDevCfgInnerData()
    const formCfg = reactive({
      form: innerData.isEdit ? innerData.connectCfgForm : { ...defaultConnectSikoraComModel },
      optionMap: {
