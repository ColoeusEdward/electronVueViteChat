...
import { commonFormItemListMap,  defaultConnectSiemensModel, Endian32BitList, PlcModelList, PortNameList, propNameEnum } from "../enum";
import { useDevCfgInnerData } from "../innerData";

export default defineComponent({
  name: 'ConnectSiemensModel',
  setup(props, ctx) {
    const innerData = useDevCfgInnerData()
    const formCfg = reactive({
      form: innerData.isEdit ? innerData.connectCfgForm : { ...defaultConnectSiemensModel },
      optionMap: {
